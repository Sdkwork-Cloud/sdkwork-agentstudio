...
pushd "%ROOT%\apps\sdkwork-agentstudio-pc\packages\sdkwork-agentstudio-pc-desktop" || exit /b 1
...
call ..\..\..\sdkwork-run-node.cmd ..\..\..\scripts\ensure-tauri-dev-binary-unlocked.mjs src-tauri sdkwork-agentstudio-pc-desktop
if errorlevel 1 goto :end
