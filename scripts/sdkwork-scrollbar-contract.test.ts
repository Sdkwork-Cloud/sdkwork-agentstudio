...
runTest('sdkwork-agentstudio-pc-shell exposes a theme-aware global scrollbar system', () => {
  const stylesSource = read('packages/sdkwork-agentstudio-pc-shell/src/styles/index.css');
...
runTest('sdkwork-agentstudio-pc-shell styles visible scroll containers consistently while preserving opt-out utilities', () => {
  const stylesSource = read('packages/sdkwork-agentstudio-pc-shell/src/styles/index.css');
