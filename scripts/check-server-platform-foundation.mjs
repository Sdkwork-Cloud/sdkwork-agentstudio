...
assertPath('packages/sdkwork-clawstudio-server/package.json', 'server package');
assertPath('packages/sdkwork-clawstudio-server/.env.example', 'server env example');
assertPath('packages/sdkwork-clawstudio-server/src/index.ts', 'server TypeScript entry');
assertPath('packages/sdkwork-clawstudio-server/src-host/Cargo.toml', 'server Cargo manifest');
assertPath('packages/sdkwork-clawstudio-server/src-host/src/main.rs', 'server Rust entry');
assertPath('packages/sdkwork-clawstudio-server/src-host/src/bootstrap.rs', 'server bootstrap module');
assertPath('packages/sdkwork-clawstudio-server/src-host/src/cli.rs', 'server cli module');
assertPath('packages/sdkwork-clawstudio-server/src-host/src/config.rs', 'server config module');
assertPath('scripts/run-cargo.mjs', 'shared cargo launcher');
assertPath(
  'packages/sdkwork-clawstudio-server/src-host/src/port_governance.rs',
  'server port governance module',
);
assertPath('packages/sdkwork-clawstudio-server/src-host/src/service.rs', 'server service module');
assertPath('packages/sdkwork-clawstudio-server/src-host/src/http/mod.rs', 'server http module');
assertPath('packages/sdkwork-clawstudio-server/src-host/src/http/router.rs', 'server router module');
assertPath(
  'packages/sdkwork-clawstudio-server/src-host/src/http/error_response.rs',
  'server error response module',
);
assertPath('packages/sdkwork-clawstudio-server/src-host/src/http/routes/health.rs', 'server health route');
assertPath(
...
assertPath(
  'packages/sdkwork-clawstudio-server/src-host/src/http/routes/manage_rollouts.rs',
  'server manage rollout route',
);
assertPath(
  'packages/sdkwork-clawstudio-server/src-host/src/http/routes/manage_service.rs',
...
const serverPackage = readJson('packages/sdkwork-clawstudio-server/package.json');

if (rootPackage?.scripts?.['server:dev'] !== 'sdkwork-run-pnpm --dir packages/sdkwork-clawstudio-server dev') {
  failures.push('Root package server:dev script must delegate to the server package dev entry.');
}
if (rootPackage?.scripts?.['server:build'] !== 'sdkwork-run-node scripts/run-clawstudio-server-build.mjs') {
  failures.push('Root package server:build script must use the shared server build helper.');
}
if (
  rootPackage?.scripts?.['check:server']
  !== 'sdkwork-run-node scripts/check-server-platform-foundation.mjs && sdkwork-run-node scripts/run-cargo.mjs test --manifest-path packages/sdkwork-clawstudio-server/src-host/Cargo.toml'
) {
...
if (serverPackage?.scripts?.build !== 'sdkwork-run-node ../../scripts/run-clawstudio-server-build.mjs') {
  failures.push('Server package build script must use the shared server build helper.');
}

assertIncludes(
  'packages/sdkwork-clawstudio-server/.env.example',
  'CLAW_SERVER_CONFIG=',
...
assertIncludes(
  'packages/sdkwork-clawstudio-server/src-host/src/cli.rs',
  'ClawServerCliCommand',
  'server cli command contract',
);
assertIncludes(
  'packages/sdkwork-clawstudio-server/src-host/src/config.rs',
  'CLAW_SERVER_CONFIG',
...
assertIncludes(
  'packages/sdkwork-clawstudio-server/src-host/src/service.rs',
...
assertIncludes(
  'packages/sdkwork-clawstudio-server/src-host/src/http/mod.rs',
...
assertIncludes(
  'packages/sdkwork-clawstudio-server/src-host/src/http/router.rs',
  'state.web_dist_dir',
...
assertIncludes(
  'docs/reference/clawstudio-server-runtime.md',
  'clawstudio-server print-config',
...
assertIncludes(
  'docs/zh-CN/reference/clawstudio-server-runtime.md',
  'print-config',
