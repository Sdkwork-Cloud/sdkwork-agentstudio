...
assertPath(
  'packages/sdkwork-agentstudio-pc-infrastructure/src/platform/contracts/storage.ts',
  'storage bridge contract module',
);
assertPath(
  'packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStorage.ts',
  'web storage bridge module',
);
assertPath(
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/storage_commands.rs',
  'desktop storage command module',
);
assertPath(
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/storage/drivers.rs',
  'desktop storage drivers module',
);
assertPath(
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/storage/profiles.rs',
  'desktop storage profiles module',
);
assertPath(
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/storage/registry.rs',
...
assertIncludes(
  'packages/sdkwork-agentstudio-pc-infrastructure/src/platform/registry.ts',
  'storage:',
