...
const requiredPaths = [
  ['packages/sdkwork-agentstudio-pc-shell/package.json', 'shell package'],
  ['packages/sdkwork-agentstudio-pc-shell/src/index.ts', 'shell entry'],
  ['packages/sdkwork-agentstudio-pc-desktop/package.json', 'desktop package'],
  ['packages/sdkwork-agentstudio-pc-desktop/.env.example', 'desktop env example'],
  ['packages/sdkwork-agentstudio-pc-desktop/src/main.tsx', 'desktop entry'],
  ['packages/sdkwork-agentstudio-pc-desktop/src/desktop/catalog.ts', 'desktop command and event catalog module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src/desktop/runtime.ts', 'desktop runtime bridge module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src/desktop/tauriBridge.ts', 'desktop bridge'],
  ['packages/sdkwork-agentstudio-pc-desktop/src/desktop/studioCommandCompat.ts', 'desktop studio command compatibility bridge'],
  ['packages/sdkwork-agentstudio-pc-infrastructure/src/config/env.ts', 'desktop env config module'],
  ['packages/sdkwork-agentstudio-pc-infrastructure/src/updates/contracts.ts', 'desktop update contracts module'],
  ['packages/sdkwork-agentstudio-pc-infrastructure/src/updates/updateClient.ts', 'desktop update client module'],
  ['packages/sdkwork-agentstudio-pc-core/src/services/updateService.ts', 'desktop update business service'],
  ['packages/sdkwork-agentstudio-pc-core/src/stores/useUpdateStore.ts', 'desktop update state store'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/Cargo.toml', 'desktop Cargo manifest'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/tauri.conf.json', 'desktop Tauri config'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/tauri.windows.conf.json', 'desktop Windows Tauri config'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/tauri.linux.conf.json', 'desktop Linux Tauri config'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/tauri.macos.conf.json', 'desktop macOS Tauri config'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/generated', 'desktop generated resource root'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/resources/openclaw/.gitkeep', 'packaged OpenClaw runtime placeholder'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/mod.rs', 'desktop framework module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/error.rs', 'desktop framework error module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/context.rs', 'desktop framework context module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/paths.rs', 'desktop framework paths module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/config.rs', 'desktop framework config module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/kernel.rs', 'desktop framework kernel contract module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/logging.rs', 'desktop framework logging module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/events.rs', 'desktop framework events module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/filesystem.rs', 'desktop framework filesystem module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/policy.rs', 'desktop framework policy module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/runtime.rs', 'desktop framework runtime module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/storage.rs', 'desktop framework storage contract module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/mod.rs', 'desktop framework services module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/system.rs', 'desktop system service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/kernel.rs', 'desktop kernel assembler service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy.rs', 'desktop local ai proxy runtime service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/config.rs', 'desktop local ai proxy config module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/projection.rs', 'desktop local ai proxy managed provider projection module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/health.rs', 'desktop local ai proxy health and status projection module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/openai_compatible.rs', 'desktop local ai proxy openai-compatible request-serving module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/observability_store.rs', 'desktop local ai proxy observability-store module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/request_context.rs', 'desktop local ai proxy request-context module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/types.rs', 'desktop local ai proxy shared types module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/response_io.rs', 'desktop local ai proxy shared response/error module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy/router.rs', 'desktop local ai proxy router module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy_snapshot.rs', 'desktop local ai proxy snapshot module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/security.rs', 'desktop security service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/notifications.rs', 'desktop notifications service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/payments.rs', 'desktop payments service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/integrations.rs', 'desktop integrations service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/openclaw_runtime.rs', 'desktop packaged OpenClaw runtime service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/path_registration.rs', 'desktop packaged OpenClaw path registration service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/permissions.rs', 'desktop permissions service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/process.rs', 'desktop process service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/jobs.rs', 'desktop jobs service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/browser.rs', 'desktop browser service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/dialog.rs', 'desktop dialog service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/storage.rs', 'desktop storage service module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/plugins/mod.rs', 'desktop plugin registration module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/app_info.rs', 'desktop app info command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/desktop_kernel.rs', 'desktop kernel command module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/get_app_paths.rs', 'desktop app paths command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/get_app_config.rs', 'desktop app config command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/process_commands.rs', 'desktop process command module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/job_commands.rs', 'desktop job command module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/list_directory.rs', 'desktop list directory command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/create_directory.rs', 'desktop create directory command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/remove_path.rs', 'desktop remove path command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/copy_path.rs', 'desktop copy path command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/move_path.rs', 'desktop move path command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/path_exists.rs', 'desktop path exists command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/get_path_info.rs', 'desktop path info command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/read_binary_file.rs', 'desktop binary read command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/write_binary_file.rs', 'desktop binary write command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/open_external.rs', 'desktop open external command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/select_files.rs', 'desktop select files command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/save_blob_file.rs', 'desktop save blob file command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/fetch_remote_url.rs', 'desktop remote url fetch command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/capture_screenshot.rs', 'desktop capture screenshot command'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/state/mod.rs', 'desktop state module'],
  ['packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/platform/mod.rs', 'desktop platform module'],
  ...
  ['packages/sdkwork-agentstudio-pc-distribution/package.json', 'distribution package'],
  ['packages/sdkwork-agentstudio-pc-distribution/src/index.ts', 'distribution entry'],
  ['packages/sdkwork-agentstudio-pc-distribution/src/manifests/cn/index.ts', 'cn distribution manifest'],
  ['packages/sdkwork-agentstudio-pc-distribution/src/manifests/global/index.ts', 'global distribution manifest'],
];
...
for (const [relativePath, label] of [
  [
    'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/api_router_managed_runtime.rs',
    'desktop bundled api router runtime service module',
  ],
  [
    'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/api_router_runtime.rs',
    'desktop api router runtime service module',
  ],
  [
    'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/commands/api_router_runtime.rs',
...
const desktopPackagePath = 'packages/sdkwork-agentstudio-pc-desktop/package.json';
const rootPackage = readJson(rootPackagePath);
const desktopPackage = readJson(desktopPackagePath);

for (const scriptName of ['dev:desktop', 'build:desktop']) {
  assertScript(rootPackage, rootPackagePath, scriptName);
  assertScript(desktopPackage, desktopPackagePath, scriptName);
}

assertScript(desktopPackage, desktopPackagePath, 'sdk:prepare-openclaw-runtime');
assertScript(rootPackage, rootPackagePath, 'sync:bundled-components');

if (
  rootPackage?.scripts?.['check:desktop']
  && !rootPackage.scripts['check:desktop'].includes('sdkwork-run-node scripts/run-cargo.mjs test --manifest-path packages/sdkwork-agentstudio-pc-desktop/src-tauri/Cargo.toml')
) {
...
assertIncludes(
  'packages/sdkwork-agentstudio-pc-desktop/src/desktop/studioCommandCompat.ts',
...
assertIncludes(
  'packages/sdkwork-agentstudio-pc-desktop/src/index.ts',
  'DESKTOP_COMMANDS',
...
assertNotIncludes(
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/Cargo.lock',
  'name = "pipewire"',
...
assertIncludes(
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/tauri.conf.json',
...
const tauriWindowsBundleConfig = readJson('packages/sdkwork-agentstudio-pc-desktop/src-tauri/tauri.windows.conf.json');
...
if (existsSync(path.join(rootDir, 'packages/sdkwork-agentstudio-pc-desktop/src-tauri/installer-hooks.nsh'))) {
  failures.push('Legacy Windows OpenClaw installer hooks must be removed after the external-runtime hard cut.');
}

const tauriLinuxBundleConfig = readJson('packages/sdkwork-agentstudio-pc-desktop/src-tauri/tauri.linux.conf.json');
...
assertIncludes(
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/events.rs',
  'job://updated',
...
assertIncludes(
  'packages/sdkwork-agentstudio-pc-infrastructure/src/config/env.ts',
  'export function createAppEnvConfig',
  'typed env factory',
);
assertIncludes(
  'packages/sdkwork-agentstudio-pc-infrastructure/src/updates/updateClient.ts',
  'APP_UPDATE_CHECK_PATH',
  'backend update check path constant',
);
assertIncludes(
  'packages/sdkwork-agentstudio-pc-core/src/services/updateService.ts',
  'checkForAppUpdate',
...
assertIncludes(
  'packages/sdkwork-agentstudio-pc-core/src/stores/useUpdateStore.ts',
  'runStartupCheck',
...
assertIncludes(
  '.gitignore',
  'packages/sdkwork-agentstudio-pc-desktop/src-tauri/resources/openclaw/*',
  'bundled openclaw generated resource ignore rule',
);
assertIncludes(
  '.gitignore',
  '!packages/sdkwork-agentstudio-pc-desktop/src-tauri/resources/openclaw/.gitkeep',
