...
const routerSource = read('packages/sdkwork-agentstudio-pc-server/src-host/src/http/router.rs');
const httpModSource = read('packages/sdkwork-agentstudio-pc-server/src-host/src/http/mod.rs');
const mainSource = read('packages/sdkwork-agentstudio-pc-server/src-host/src/main.rs');
