...
assertPath(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/capabilities.rs',
...
assertPath(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/storage.rs',
...
assertPath(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/security.rs',
  'desktop security service module',
);
assertPath(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/notifications.rs',
  'desktop notifications service module',
);
assertPath(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/payments.rs',
  'desktop payments service module',
);
assertPath(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/integrations.rs',
  'desktop integrations service module',
);
assertPath(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/permissions.rs',
...
assertIncludes(
  'packages/sdkwork-clawstudio-desktop/src-tauri/src/commands/get_app_config.rs',
  'PublicAppConfig',
