...
This directory is the local standards index for `@sdkwork/clawstudio-community`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-community` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-community` |
