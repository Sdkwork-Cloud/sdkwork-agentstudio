...
This directory is the local standards index for `@sdkwork/clawstudio-channels`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-channels` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-channels` |
| Domain | `platform` |
