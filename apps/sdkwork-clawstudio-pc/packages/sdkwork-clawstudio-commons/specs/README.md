...
This directory is the local standards index for `@sdkwork/clawstudio-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-commons` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-commons` |
| Domain | `platform` |
