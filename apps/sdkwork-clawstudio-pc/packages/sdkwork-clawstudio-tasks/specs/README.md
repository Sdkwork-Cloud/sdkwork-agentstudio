...
This directory is the local standards index for `@sdkwork/clawstudio-tasks`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-tasks` |
| Type | `node-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-tasks` |
| Domain | `platform` |
