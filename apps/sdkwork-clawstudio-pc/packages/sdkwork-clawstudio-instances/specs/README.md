...
This directory is the local standards index for `@sdkwork/clawstudio-instances`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-instances` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-instances` |
| Domain | `platform` |
