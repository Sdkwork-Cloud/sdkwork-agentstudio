...
This directory is the local standards index for `sdkwork-clawstudio-host-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawstudio-host-core` |
| Type | `rust-crate` |
| Root | `claw-studio/packages/sdkwork-clawstudio-host-core/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/claw-studio/packages/sdkwork-clawstudio-host-core/src-host/Cargo.toml`
