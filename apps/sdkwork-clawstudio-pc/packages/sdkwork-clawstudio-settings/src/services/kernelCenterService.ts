...
import { mapKernelPlatformSnapshot } from '@sdkwork/clawstudio-core';
import type {
...
import { runtime } from '@sdkwork/clawstudio-infrastructure';
...
type ClawCoreModule = typeof import('@sdkwork/clawstudio-core');
...
function loadClawCoreModule(): Promise<ClawCoreModule> {
  clawCoreModulePromise ??= import('@sdkwork/clawstudio-core');
