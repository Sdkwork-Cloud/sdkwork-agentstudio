...
This directory is the local standards index for `@sdkwork/clawstudio-settings`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-settings` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-settings` |
| Domain | `platform` |
| Capability | `settings` |
