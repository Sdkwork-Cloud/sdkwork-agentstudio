...
This directory is the local standards index for `@sdkwork/clawstudio-dashboard`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-dashboard` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-dashboard` |
| Domain | `platform` |
