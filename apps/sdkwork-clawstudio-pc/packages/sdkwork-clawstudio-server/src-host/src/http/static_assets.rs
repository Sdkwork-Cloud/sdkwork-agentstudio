...
const BROWSER_SESSION_TOKEN_META_NAME: &str = "sdkwork-clawstudio-browser-session-token";
const SERVER_BROWSER_BOOTSTRAP_DESCRIPTOR_PATH: &str = "/sdkwork-clawstudio-bootstrap.json";
...
fn inject_server_host_metadata(html: &str, host_metadata: ServerBrowserHostMetadata) -> String {
    ...
    let accelerator_metadata = host_metadata
        ...
        .map(|profile| {
            format!(
                "\n    <meta name=\"sdkwork-clawstudio-accelerator-profile\" content=\"{}\" />",
                escape_html_attribute(profile)
            )
        })
        .unwrap_or_default();
    let metadata = format!(
        "\n    <meta name=\"sdkwork-clawstudio-host-mode\" content=\"{}\" />\n    <meta name=\"sdkwork-clawstudio-distribution-family\" content=\"{}\" />\n    <meta name=\"sdkwork-clawstudio-deployment-family\" content=\"{}\" />{}\n    <meta name=\"sdkwork-clawstudio-api-base-path\" content=\"{}\" />\n    <meta name=\"sdkwork-clawstudio-manage-base-path\" content=\"{}\" />\n    <meta name=\"sdkwork-clawstudio-internal-base-path\" content=\"{}\" />{}\n",
...
fn strip_server_host_metadata(html: &str) -> String {
    [
        "sdkwork-clawstudio-host-mode",
        "sdkwork-clawstudio-distribution-family",
        "sdkwork-clawstudio-deployment-family",
        "sdkwork-clawstudio-accelerator-profile",
        "sdkwork-clawstudio-api-base-path",
        "sdkwork-clawstudio-manage-base-path",
        "sdkwork-clawstudio-internal-base-path",
...
mod tests {
    ...
    fn inject_server_host_metadata_marks_server_mode_and_base_paths() {
        ...
        assert!(html.contains("sdkwork-clawstudio-host-mode"));
        assert!(html.contains("sdkwork-clawstudio-distribution-family"));
        assert!(html.contains("sdkwork-clawstudio-deployment-family"));
        assert!(html.contains("sdkwork-clawstudio-accelerator-profile"));
        assert!(html.contains("sdkwork-clawstudio-api-base-path"));
        assert!(html.contains("sdkwork-clawstudio-manage-base-path"));
        assert!(html.contains("sdkwork-clawstudio-internal-base-path"));
    ...
    fn inject_server_host_metadata_refreshes_existing_host_metadata_values() {
        let html = inject_server_host_metadata(
            "<html><head>\
<meta name=\"sdkwork-clawstudio-host-mode\" content=\"desktopCombined\" />\
<meta name=\"sdkwork-clawstudio-distribution-family\" content=\"desktop\" />\
<meta name=\"sdkwork-clawstudio-deployment-family\" content=\"bareMetal\" />\
<meta name=\"sdkwork-clawstudio-accelerator-profile\" content=\"cpu\" />\
<meta name=\"sdkwork-clawstudio-api-base-path\" content=\"/wrong/api\" />\
<meta name=\"sdkwork-clawstudio-manage-base-path\" content=\"/wrong/manage\" />\
<meta name=\"sdkwork-clawstudio-internal-base-path\" content=\"/wrong/internal\" />\
<meta name=\"sdkwork-clawstudio-browser-session-token\" content=\"stale-token\" />\
</head><body></body></html>",
            ServerBrowserHostMetadata {
                mode: "server",
                distribution_family: "server",
        ...
        assert!(html.contains("<meta name=\"sdkwork-clawstudio-host-mode\" content=\"server\" />"));
        assert!(
            html.contains("<meta name=\"sdkwork-clawstudio-distribution-family\" content=\"server\" />")
        );
        assert!(html
            .contains("<meta name=\"sdkwork-clawstudio-deployment-family\" content=\"kubernetes\" />"));
        assert!(html.contains(
            "<meta name=\"sdkwork-clawstudio-accelerator-profile\" content=\"nvidia-cuda\" />"
        ));
        assert!(html.contains(&format!(
            "<meta name=\"{BROWSER_SESSION_TOKEN_META_NAME}\" content=\"fresh-token\" />"
        )));
        assert!(html.contains(&format!(
            "<meta name=\"sdkwork-clawstudio-api-base-path\" content=\"{DEFAULT_STUDIO_API_BASE_PATH}\" />"
        )));
        assert!(html.contains(&format!(
            "<meta name=\"sdkwork-clawstudio-manage-base-path\" content=\"{DEFAULT_MANAGE_BASE_PATH}\" />"
        )));
        assert!(html.contains(&format!(
            "<meta name=\"sdkwork-clawstudio-internal-base-path\" content=\"{DEFAULT_INTERNAL_BASE_PATH}\" />"
        )));
        assert!(!html.contains("content=\"desktopCombined\""));
        assert!(!html.contains("content=\"bareMetal\""));
    ...
    fn inject_server_host_metadata_removes_stale_optional_metadata_when_unconfigured() {
        let html = inject_server_host_metadata(
            "<html><head>\
<meta name=\"sdkwork-clawstudio-host-mode\" content=\"server\" />\
<meta name=\"sdkwork-clawstudio-distribution-family\" content=\"server\" />\
<meta name=\"sdkwork-clawstudio-deployment-family\" content=\"container\" />\
<meta name=\"sdkwork-clawstudio-accelerator-profile\" content=\"amd-rocm\" />\
<meta name=\"sdkwork-clawstudio-api-base-path\" content=\"/claw/api/v1\" />\
<meta name=\"sdkwork-clawstudio-manage-base-path\" content=\"/claw/manage/v1\" />\
<meta name=\"sdkwork-clawstudio-internal-base-path\" content=\"/claw/internal/v1\" />\
<meta name=\"sdkwork-clawstudio-browser-session-token\" content=\"stale-token\" />\
</head><body></body></html>",
            ServerBrowserHostMetadata {
                mode: "server",
        ...
        assert!(
            html.contains("<meta name=\"sdkwork-clawstudio-deployment-family\" content=\"container\" />")
        );
    }
    ...
    fn inject_server_host_metadata_escapes_dynamic_metadata_values() {
        ...
        assert!(html.contains(
            "<meta name=\"sdkwork-clawstudio-deployment-family\" content=\"k8s&quot;edge&quot;&amp;&lt;prod&gt;&#39;\" />"
        ));
        assert!(html.contains(
            "<meta name=\"sdkwork-clawstudio-accelerator-profile\" content=\"nvidia&amp;&quot;cuda&quot;&lt;&#39;prod&#39;&gt;\" />"
        ));
        assert!(html.contains(
            "<meta name=\"sdkwork-clawstudio-api-base-path\" content=\"/claw/api/v1?tenant=&quot;core&quot;&amp;mode=&lt;prod&gt;\" />"
        ));
        assert!(html.contains(
            "<meta name=\"sdkwork-clawstudio-manage-base-path\" content=\"/claw/manage/v1?token=&#39;quoted&#39;\" />"
        ));
        assert!(html.contains(
            "<meta name=\"sdkwork-clawstudio-internal-base-path\" content=\"/claw/internal/v1?scope=prod&amp;kind=&quot;internal&quot;\" />"
        ));
        assert!(html.contains(&format!(
    ...
    fn create_test_dist_dir() -> std::path::PathBuf {
        ...
        let directory = std::env::temp_dir().join(format!(
            "sdkwork-clawstudio-server-static-assets-{}-{unique_suffix}",
            std::process::id()
        ));
