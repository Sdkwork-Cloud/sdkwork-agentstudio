...
This directory is the local standards index for `sdkwork-clawstudio-server`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawstudio-server` |
| Type | `rust-crate` |
| Root | `claw-studio/packages/sdkwork-clawstudio-server/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/claw-studio/packages/sdkwork-clawstudio-server/src-host/Cargo.toml`
