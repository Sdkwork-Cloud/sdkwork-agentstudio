...
This directory is the local standards index for `sdkwork-clawstudio-desktop`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawstudio-desktop` |
| Type | `tauri-host` |
| Root | `claw-studio/packages/sdkwork-clawstudio-desktop/src-tauri` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/claw-studio/packages/sdkwork-clawstudio-desktop/src-tauri/Cargo.toml`
