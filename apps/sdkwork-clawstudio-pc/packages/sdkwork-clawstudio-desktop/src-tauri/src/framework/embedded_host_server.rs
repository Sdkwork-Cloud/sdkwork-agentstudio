...
fn build_desktop_openclaw_control_plane(
...
) -> Result<sdkwork_clawstudio_host_core::openclaw_control_plane::OpenClawControlPlane> {
    let updated_at = 0;
    ...
    let mut control_plane =
        sdkwork_clawstudio_host_core::openclaw_control_plane::OpenClawControlPlane::inactive(managed_by)
...
fn build_embedded_host_server_state(
    ...
    let runtime_config = ResolvedServerRuntimeConfig {
        ...
        deployment_family: sdkwork_clawstudio_server::config::ServerDeploymentFamily::BareMetal,
    ...
    let effective_config_path = runtime_data_dir.join("clawstudio-server.config.json");
...
impl ManageOpenClawProvider for DesktopManageOpenClawProvider {
    ...
    fn get_runtime(
        ...
        sdkwork_clawstudio_host_core::host_endpoints::OpenClawRuntimeProjection,
        String,
    > {
        self.studio
    ...
    fn get_gateway(
        ...
        sdkwork_clawstudio_host_core::host_endpoints::OpenClawGatewayProjection,
        String,
    > {
        self.studio
    ...
    fn invoke_gateway(
        &self,
        request: sdkwork_clawstudio_host_core::openclaw_control_plane::OpenClawGatewayInvokeRequest,
        _updated_at: u64,
    ) -> std::result::Result<Value, String> {
        self.studio
...
mod tests {
    ...
    use sdkwork_clawstudio_host_core::host_endpoints::HostEndpointRecord;
    use sdkwork_clawstudio_host_studio::{
        StudioOpenClawGatewayInvokeOptions, StudioOpenClawGatewayInvokeRequest,
        StudioPublicApiProvider, TypedStudioPublicApiBackend,
    };
    use sdkwork_clawstudio_server::bootstrap::ServerStateStoreSnapshot;
    use serde_json::Value;
    use std::{
        fs,
        net::TcpListener,
