...
use sdkwork_clawstudio_server::bootstrap::{
...
mod tests {
    ...
    use sdkwork_clawstudio_host_core::host_endpoints::OpenClawLifecycle;
    use sdkwork_clawstudio_host_core::openclaw_control_plane::OpenClawGatewayInvokeRequest;
    use sdkwork_clawstudio_server::bootstrap::{
...
"#
    ...
    fn desktop_host_snapshot_fixture(
        ...
        crate::framework::embedded_host_server::EmbeddedHostRuntimeSnapshot {
            ...
            endpoint: sdkwork_clawstudio_host_core::host_endpoints::HostEndpointRecord {
    ...
    fn host_platform_status_matches_desktop_combined_capability_contract() {
        ...
        assert_eq!(
            ...
            sdkwork_clawstudio_server::bootstrap::host_platform_capability_keys_for_mode(
                "desktopCombined",
            )
        );
        assert_eq!(
