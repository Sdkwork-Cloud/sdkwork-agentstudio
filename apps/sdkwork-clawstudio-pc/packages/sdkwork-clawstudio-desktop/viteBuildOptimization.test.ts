...
runTest('desktop build optimization keeps core shared runtime in stable chunks', () => {
  ...
  assert.equal(
    manualChunks(
      'C:/repo/apps/claw-studio/packages/sdkwork-clawstudio-infrastructure/src/platform/registry.ts',
    ),
    'claw-infrastructure',
  );
  assert.equal(
    manualChunks(
      'C:/repo/apps/claw-studio/packages/sdkwork-clawstudio-infrastructure/src/platform/webStudio.ts',
    ),
    'claw-platform-web-studio',
  );
  assert.equal(
    manualChunks(
      'C:/repo/apps/claw-studio/packages/sdkwork-clawstudio-i18n/src/index.ts',
    ),
    'claw-i18n-runtime',
  );
  assert.equal(
    manualChunks(
      'C:/repo/apps/claw-studio/packages/sdkwork-clawstudio-i18n/src/locales/en/index.ts',
    ),
    'claw-i18n-en',
  );
  assert.equal(
    manualChunks(
      'C:/repo/apps/claw-studio/packages/sdkwork-clawstudio-i18n/src/locales/zh/index.ts',
    ),
    'claw-i18n-zh',
  );
  assert.equal(
