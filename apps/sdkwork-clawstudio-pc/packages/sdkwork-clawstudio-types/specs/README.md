...
This directory is the local standards index for `@sdkwork/clawstudio-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-types` |
| Type | `node-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-types` |
| Domain | `platform` |
