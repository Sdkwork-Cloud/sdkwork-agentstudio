...
This directory is the local standards index for `@sdkwork/clawstudio-extensions`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-extensions` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-extensions` |
| Domain | `platform` |
