...
export const SERVER_HOST_MODE_META_NAME = 'sdkwork-clawstudio-host-mode';
export const SERVER_API_BASE_PATH_META_NAME = 'sdkwork-clawstudio-api-base-path';
export const SERVER_MANAGE_BASE_PATH_META_NAME = 'sdkwork-clawstudio-manage-base-path';
export const SERVER_INTERNAL_BASE_PATH_META_NAME = 'sdkwork-clawstudio-internal-base-path';
export const SERVER_DISTRIBUTION_FAMILY_META_NAME = 'sdkwork-clawstudio-distribution-family';
export const SERVER_DEPLOYMENT_FAMILY_META_NAME = 'sdkwork-clawstudio-deployment-family';
export const SERVER_ACCELERATOR_PROFILE_META_NAME = 'sdkwork-clawstudio-accelerator-profile';
export const SERVER_BROWSER_SESSION_TOKEN_META_NAME = 'sdkwork-clawstudio-browser-session-token';
export const SERVER_BROWSER_BOOTSTRAP_DESCRIPTOR_PATH = '/sdkwork-clawstudio-bootstrap.json';
