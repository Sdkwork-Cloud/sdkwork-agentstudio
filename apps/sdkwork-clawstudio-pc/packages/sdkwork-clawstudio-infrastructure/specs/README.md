...
This directory is the local standards index for `@sdkwork/clawstudio-infrastructure`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-infrastructure` |
| Type | `node-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-infrastructure` |
| Domain | `platform` |
