...
This directory is the local standards index for `@sdkwork/clawstudio-devices`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-devices` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-devices` |
| Domain | `platform` |
