...
This directory is the local standards index for `@sdkwork/clawstudio-center`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-center` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-center` |
| Domain | `platform` |
