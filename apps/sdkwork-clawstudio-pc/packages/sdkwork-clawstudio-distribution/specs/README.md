...
This directory is the local standards index for `@sdkwork/clawstudio-distribution`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-distribution` |
| Type | `node-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-distribution` |
| Domain | `device` |
