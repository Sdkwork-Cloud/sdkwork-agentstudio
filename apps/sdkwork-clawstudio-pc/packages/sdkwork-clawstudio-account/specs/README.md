...
This directory is the local standards index for `@sdkwork/clawstudio-account`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-account` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-account` |
| Domain | `platform` |
