...
This README is the SDKWork module entrypoint for `@sdkwork/clawstudio-core`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `pnpm --filter @sdkwork/clawstudio-core test`
