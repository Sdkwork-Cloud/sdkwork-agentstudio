...
import { bootstrapShellRuntime } from '@sdkwork/clawstudio-shell';
import App from './App';

const STARTUP_FATAL_TITLE = 'Claw Studio failed to start';
...
function resolveWebRootElement(): HTMLElement {
  ...
  if (!document.body) {
    throw new Error('Claw Studio root element is missing and document.body is unavailable.');
  }
