...
import { useAppStore, type LanguagePreference } from '@sdkwork/clawstudio-core';
import { ensureI18n, i18n } from '@sdkwork/clawstudio-i18n';
...
export function AppProviders({
  ...
  useEffect(() => {
    ...
    const runDeferredStartupCheck = async () => {
      try {
        const { useUpdateStore } = await import('@sdkwork/clawstudio-core');
        if (cancelled) {
          return;
        }
