...
const AuthPage = lazy(() =>
  import('@sdkwork/clawstudio-auth').then((module) => ({
...
const AgentMarket = lazy(() =>
  import('@sdkwork/clawstudio-agent').then((module) => ({
    default: module.AgentMarket,
  })),
);
const ClawCenter = lazy(() =>
  import('@sdkwork/clawstudio-center').then((module) => ({
...
const Channels = lazy(() =>
  import('@sdkwork/clawstudio-channels').then((module) => ({
    default: module.Channels,
  })),
);
const Chat = lazy(() =>
  import('@sdkwork/clawstudio-chat').then((module) => ({
    default: module.Chat,
  })),
);
...
const Community = lazy(() =>
  import('@sdkwork/clawstudio-community').then((module) => ({
...
const Devices = lazy(() =>
  import('@sdkwork/clawstudio-devices').then((module) => ({
    default: module.Devices,
  })),
);
const Dashboard = lazy(() =>
  import('@sdkwork/clawstudio-dashboard').then((module) => ({
...
const Docs = lazy(() =>
  import('@sdkwork/clawstudio-docs').then((module) => ({
    default: module.Docs,
  })),
);
const Extensions = lazy(() =>
  import('@sdkwork/clawstudio-extensions').then((module) => ({
    default: module.Extensions,
  })),
);
const InstanceDetail = lazy(() =>
  import('@sdkwork/clawstudio-instances').then((module) => ({
...
const Settings = lazy(() =>
  import('@sdkwork/clawstudio-settings').then((module) => ({
...
const Tasks = lazy(() =>
  import('@sdkwork/clawstudio-tasks').then((module) => ({
