...
This directory is the local standards index for `@sdkwork/clawstudio-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/clawstudio-shell` |
| Type | `react-package` |
| Root | `claw-studio/packages/sdkwork-clawstudio-shell` |
| Domain | `platform` |
| Capability | `shell` |
