...
export interface AppHeaderProps {
  mode?: 'default' | 'auth' | 'window-controls';
  windowControlLabels?: DesktopWindowControlLabels;
}

function AppHeaderFrame({
  children,
}: {
  children: ReactNode;
}) {
...
function WindowControlsOnlyHeader({
  windowControlLabels,
}: {
  windowControlLabels?: DesktopWindowControlLabels;
}) {
...
export function AppHeader({
  ...
  if (mode === 'window-controls') {
    return <WindowControlsOnlyHeader windowControlLabels={windowControlLabels} />;
  }

  return <WorkspaceAppHeader mode={mode} />;
}
