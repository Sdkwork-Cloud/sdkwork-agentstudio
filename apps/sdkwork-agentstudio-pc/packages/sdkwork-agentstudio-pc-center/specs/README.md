# SDKWork Claw Center Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-center`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-center` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-center` |
| Domain | `platform` |
