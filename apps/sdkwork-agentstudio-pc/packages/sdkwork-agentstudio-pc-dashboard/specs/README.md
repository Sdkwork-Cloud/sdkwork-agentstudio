# SDKWork Claw Dashboard Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-dashboard`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-dashboard` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-dashboard` |
| Domain | `platform` |
