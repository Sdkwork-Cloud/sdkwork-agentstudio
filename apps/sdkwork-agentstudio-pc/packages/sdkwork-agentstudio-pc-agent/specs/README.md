# SDKWork Claw Agent Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-agent`.
...
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-agent` |
| Domain | `intelligence` |
| Capability | `agent` |
