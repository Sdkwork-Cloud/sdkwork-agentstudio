# SDKWork Claw Channels Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-channels`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-channels` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-channels` |
| Domain | `platform` |
