# SDKWork Claw Host Core Component Specs

This directory is the local standards index for `sdkwork-agentstudio-pc-host-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-agentstudio-pc-host-core` |
| Type | `rust-crate` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-host-core/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/agent-studio/packages/sdkwork-agentstudio-pc-host-core/src-host/Cargo.toml`
