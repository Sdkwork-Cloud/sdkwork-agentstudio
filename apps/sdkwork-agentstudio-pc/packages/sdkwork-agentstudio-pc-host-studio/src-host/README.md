...
This README is the SDKWork module entrypoint for `sdkwork-agentstudio-pc-host-studio`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/agent-studio/packages/sdkwork-agentstudio-pc-host-studio/src-host/Cargo.toml`
