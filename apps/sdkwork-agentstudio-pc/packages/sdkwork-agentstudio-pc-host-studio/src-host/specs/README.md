# SDKWork Claw Host Studio Component Specs

This directory is the local standards index for `sdkwork-agentstudio-pc-host-studio`.
...
| Type | `rust-crate` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-host-studio/src-host` |
| Domain | `device` |
