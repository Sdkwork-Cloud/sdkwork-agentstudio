...
export const SERVER_HOST_MODE_META_NAME = 'sdkwork-agentstudio-pc-host-mode';
export const SERVER_API_BASE_PATH_META_NAME = 'sdkwork-agentstudio-pc-api-base-path';
export const SERVER_MANAGE_BASE_PATH_META_NAME = 'sdkwork-agentstudio-pc-manage-base-path';
export const SERVER_INTERNAL_BASE_PATH_META_NAME = 'sdkwork-agentstudio-pc-internal-base-path';
export const SERVER_DISTRIBUTION_FAMILY_META_NAME = 'sdkwork-agentstudio-pc-distribution-family';
export const SERVER_DEPLOYMENT_FAMILY_META_NAME = 'sdkwork-agentstudio-pc-deployment-family';
export const SERVER_ACCELERATOR_PROFILE_META_NAME = 'sdkwork-agentstudio-pc-accelerator-profile';
export const SERVER_BROWSER_SESSION_TOKEN_META_NAME = 'sdkwork-agentstudio-pc-browser-session-token';
export const SERVER_BROWSER_BOOTSTRAP_DESCRIPTOR_PATH = '/sdkwork-agentstudio-pc-bootstrap.json';
