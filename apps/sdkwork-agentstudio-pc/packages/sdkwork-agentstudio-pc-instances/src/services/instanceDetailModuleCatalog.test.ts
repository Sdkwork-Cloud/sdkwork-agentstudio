...
let kernelDetailModuleRegistryModule:
  | typeof import('../../../sdkwork-agentstudio-pc-core/src/services/kernelDetailModuleRegistry.ts')
  | undefined;
...
try {
  kernelDetailModuleRegistryModule = await import(
    '../../../sdkwork-agentstudio-pc-core/src/services/kernelDetailModuleRegistry.ts'
  );
} catch {
