# SDKWork Claw Instances Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-instances`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-instances` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-instances` |
| Domain | `platform` |
