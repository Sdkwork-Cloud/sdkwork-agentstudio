# SDKWork Claw Distribution Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-distribution`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-distribution` |
| Type | `node-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-distribution` |
| Domain | `device` |
