...
export function resolveBackgroundRuntimeReadinessToastCopy(
  ...
  if (recoveryMode === 'generic-hosted-runtime') {
    if (language === 'zh') {
      return {
        ...
        description: normalizedMessage
          ? `Agent Studio \u5df2\u6253\u5f00\uff0c\u4f46\u684c\u9762\u8fd0\u884c\u65f6\u7684\u540e\u53f0\u5c31\u7eea\u68c0\u67e5\u672a\u80fd\u5b8c\u6210\u3002\u53ef\u4ee5\u7acb\u5373\u91cd\u8bd5\u68c0\u67e5\uff0c\u6216\u6253\u5f00\u5b9e\u4f8b\u5217\u8868\u68c0\u67e5\u5f53\u524d\u72b6\u6001\u3002\n\n${normalizedMessage}`
          : 'Agent Studio \u5df2\u6253\u5f00\uff0c\u4f46\u684c\u9762\u8fd0\u884c\u65f6\u7684\u540e\u53f0\u5c31\u7eea\u68c0\u67e5\u672a\u80fd\u5b8c\u6210\u3002\u53ef\u4ee5\u7acb\u5373\u91cd\u8bd5\u68c0\u67e5\uff0c\u6216\u6253\u5f00\u5b9e\u4f8b\u5217\u8868\u68c0\u67e5\u5f53\u524d\u72b6\u6001\u3002',
    ...
    return {
      ...
      description: normalizedMessage
        ? `Agent Studio opened, but desktop runtime readiness did not converge in the background. Retry the check now or open the instances list to inspect the current state.\n\n${normalizedMessage}`
        : 'Agent Studio opened, but desktop runtime readiness did not converge in the background. Retry the check now or open the instances list to inspect the current state.',
  ...
  if (language === 'zh') {
    return {
      ...
      description: normalizedMessage
        ? `Agent Studio \u5df2\u6253\u5f00\uff0c\u4f46\u5185\u7f6e OpenClaw \u672a\u80fd\u5728\u540e\u53f0\u5b8c\u6210\u5c31\u7eea\u3002\u53ef\u4ee5\u7acb\u5373\u91cd\u8bd5\uff0c\u6216\u6253\u5f00\u5b9e\u4f8b\u8be6\u60c5\u68c0\u67e5\u65e5\u5fd7\u3002\n\n${normalizedMessage}`
        : 'Agent Studio \u5df2\u6253\u5f00\uff0c\u4f46\u5185\u7f6e OpenClaw \u672a\u80fd\u5728\u540e\u53f0\u5b8c\u6210\u5c31\u7eea\u3002\u53ef\u4ee5\u7acb\u5373\u91cd\u8bd5\uff0c\u6216\u6253\u5f00\u5b9e\u4f8b\u8be6\u60c5\u68c0\u67e5\u65e5\u5fd7\u3002',
  ...
  return {
    ...
    description: normalizedMessage
      ? `Agent Studio opened, but the built-in OpenClaw runtime did not become ready in the background. Retry it now or open the instance details to inspect logs.\n\n${normalizedMessage}`
      : 'Agent Studio opened, but the built-in OpenClaw runtime did not become ready in the background. Retry it now or open the instance details to inspect logs.',
