...
import { platform } from '@sdkwork/agentstudio-pc-core';
import { OverlaySurface } from '@sdkwork/agentstudio-pc-ui';
...
const mobileChannelLinks: Record<MobileAppGuideChannelId, string> = {
  android: 'https://agentstudio.sdkwork.com/platforms/android',
  ios: 'https://agentstudio.sdkwork.com/platforms/ios',
  harmony: 'https://agentstudio.sdkwork.com/platforms/harmony',
};
