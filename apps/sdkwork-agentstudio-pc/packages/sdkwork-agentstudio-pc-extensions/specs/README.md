# SDKWork Claw Extensions Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-extensions`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-extensions` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-extensions` |
| Domain | `platform` |
