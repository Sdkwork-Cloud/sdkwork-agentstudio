# SDKWork Claw Docs Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-docs`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-docs` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-docs` |
| Domain | `content` |
| Capability | `docs` |
