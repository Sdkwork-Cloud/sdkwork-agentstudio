# SDKWork Claw Account Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-account`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-account` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-account` |
| Domain | `platform` |
