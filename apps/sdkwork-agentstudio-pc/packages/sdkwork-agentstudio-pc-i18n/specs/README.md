# SDKWork Claw I18n Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-i18n` |
| Type | `node-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-i18n` |
| Domain | `platform` |
