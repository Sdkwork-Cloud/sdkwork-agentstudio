...
import {
  AGENT_STUDIO_USER_CENTER_GATEWAY_ENV_PREFIX,
  AGENT_STUDIO_USER_CENTER_NAMESPACE,
  AGENT_STUDIO_USER_CENTER_ROUTES,
  AGENT_STUDIO_USER_CENTER_RUNTIME_ENV_PREFIX,
...
export const CLAW_AUTH_USER_CENTER_NAMESPACE = 'agent-studio';
...
export const CLAW_AUTH_USER_CENTER_PLUGIN_PACKAGES = ['@sdkwork/agentstudio-pc-auth'] as const;
...
function createClawAuthUserCenterBasePluginArtifacts(
  ...
  const plugin = createUserCenterPluginDefinition({
    ...
    storageTopology: options.storageTopology,
    theme: options.theme,
    title: options.title ?? 'Agent Studio User Center',
  });
...
function createClawAuthDeploymentArtifactFileName(
  ...
  return `agent-studio.${kind}.${basename}`;
}
...
function createClawAuthUserCenterClientDeploymentProfile(
  ...
  const runtimeEnvArtifact = Object.freeze(createUserCenterDeploymentEnvArtifact({
    ...
    headerComment: `Agent Studio ${profile.kind} runtime env`,
    purpose: `Public runtime env artifact for the Agent Studio ${profile.kind} user-center deployment.`,
  ...
  const gatewayEnvArtifact = Object.freeze(createUserCenterDeploymentEnvArtifact({
    ...
    headerComment: `Agent Studio ${profile.kind} gateway env`,
    purpose: `Private gateway env artifact for the Agent Studio ${profile.kind} user-center deployment.`,
...
export function createClawAuthUserCenterServerPluginDefinition(
  ...
  return createUserCenterServerPluginDefinition({
    ...
    storageTopology: options.storageTopology,
    title: options.title ?? 'Agent Studio User Center Server',
  });
}
...
export function createClawAuthUserCenterServerValidationPluginDefinition(
  ...
  return createUserCenterServerValidationPluginDefinition({
    packageNames: options.packageNames ?? [...CLAW_AUTH_USER_CENTER_PLUGIN_PACKAGES],
    title: options.title ?? 'Agent Studio User Center Server Validation',
