...
import { mapKernelPlatformSnapshot } from '@sdkwork/agentstudio-pc-core';
import type {
...
import { runtime } from '@sdkwork/agentstudio-pc-infrastructure';
...
type ClawCoreModule = typeof import('@sdkwork/agentstudio-pc-core');
...
function loadClawCoreModule(): Promise<ClawCoreModule> {
  clawCoreModulePromise ??= import('@sdkwork/agentstudio-pc-core');
