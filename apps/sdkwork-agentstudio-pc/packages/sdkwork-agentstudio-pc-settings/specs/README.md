# SDKWork Claw Settings Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-settings`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-settings` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-settings` |
| Domain | `platform` |
| Capability | `settings` |
