# SDKWork Claw Devices Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-devices`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-devices` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-devices` |
| Domain | `platform` |
