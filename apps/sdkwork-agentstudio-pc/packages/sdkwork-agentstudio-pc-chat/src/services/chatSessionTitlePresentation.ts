...
const GENERIC_CHAT_SESSION_TITLE_PATTERN =
  /^(?:assistant|cli|agent-studio|default|main|openclaw|openclaw[-_/ ](?:cli|gateway|studio|tui|web)|studio-web|system|tui)$/i;
...
export function isOpaqueChatSessionTitle(value: string | null | undefined) {
  ...
  return (
    ...
    /^agent-studio:/i.test(normalized) ||
