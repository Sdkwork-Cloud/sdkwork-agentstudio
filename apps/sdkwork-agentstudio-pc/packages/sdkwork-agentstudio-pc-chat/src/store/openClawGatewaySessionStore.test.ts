...
class MockGatewayClient implements OpenClawGatewayClientLike {
  ...
  nextSendResult: { runId?: string; response?: unknown } | null = null;
  ...
  async sendChatMessage(params: Record<string, unknown>) {
    ...
    const nextSendResult = this.nextSendResult;
    this.nextSendResult = null;
    return {
      runId: nextSendResult?.runId ?? 'run-1',
      ...(nextSendResult && 'response' in nextSendResult
        ? { response: nextSendResult.response }
        : {}),
    };
  }
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-agent-tools`;
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 410,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-streaming`;
      },
    });
...
await runTest(
  'openclaw gateway session store displays a chat.send response in the current session',
  async () => {
    const client = new MockGatewayClient(
      {
        ts: 1,
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 420,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-send-response`;
      },
    });

    await store.hydrateInstance('instance-a');
    const draft = store.createDraftSession('instance-a', 'OpenClaw A');
    client.nextSendResult = {
      runId: 'run-rpc-1',
      response: {
        runId: 'run-other',
        sessionKey: 'agent-studio:instance-a:other-session',
        role: 'assistant',
        content: [{ type: 'text', text: 'rpc reply visible in current session' }],
      },
    };
    ...
    const snapshot = store.getSnapshot('instance-a');
    const session = snapshot.sessions.find((entry) => entry.id === draft.id);
    assert.equal(snapshot.activeSessionId, draft.id);
    assert.ok(session);
    ...
    assert.deepEqual(
      ...
      [
        { role: 'user', content: 'user message' },
        { role: 'assistant', content: 'rpc reply visible in current session' },
      ],
    );
  },
);
...
await runTest(
  'openclaw gateway session store streams top-level chat delta text into the current session',
  async () => {
    const client = new MockGatewayClient(
      {
        ts: 1,
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 421,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-top-level-delta`;
      },
    });
    ...
    assert.deepEqual(
      ...
      [
        { role: 'user', content: 'user message' },
        { role: 'assistant', content: 'partial reply completed' },
      ],
    );
  },
);
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-history-cap';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionA = 'agent-studio:instance-a:session-order-a';
    const sessionB = 'agent-studio:instance-a:session-order-b';
    const client = new MockGatewayClient(
      {
        ts: 1,
...
await runTest(
  ...
  async () => {
    const sessionA = 'agent-studio:instance-a:session-history-cap';
    const sessionB = 'agent-studio:instance-b:session-history-cap';
...
await runTest(
  ...
  async () => {
    const sessionA = 'agent-studio:instance-a:session-history-unauthorized-a';
    const sessionB = 'agent-studio:instance-a:session-history-unauthorized-b';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionA = 'agent-studio:instance-a:session-history-scope-message';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 440,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-send-error`;
      },
    });
    await store.hydrateInstance('instance-a');
    const draft = store.createDraftSession('instance-a', 'OpenClaw A');
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 445,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-send-error-message`;
      },
    });
    await store.hydrateInstance('instance-a');
    const draft = store.createDraftSession('instance-a', 'OpenClaw A');
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 450,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-abort-error`;
      },
    });
    await store.hydrateInstance('instance-a');
    const draft = store.createDraftSession('instance-a', 'OpenClaw A');
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 420,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-other-run`;
      },
    });
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-no-reply-history';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-control-reply-history';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 440,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-no-reply-chat`;
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 445,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-control-reply-chat`;
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 441,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-commentary-phase`;
      },
    });
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-no-reply-transcript';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const clientA = new MockGatewayClient(
      {
        ...
        sessions: [
          {
            key: 'agent-studio:instance-a:session-1',
            label: 'A One',
            updatedAt: 210,
            kind: 'direct',
            model: 'OpenClaw A',
          ...
          {
            key: 'agent-studio:instance-a:session-2',
            label: 'A Two',
            updatedAt: 190,
            kind: 'direct',
            model: 'OpenClaw A',
      ...
      {
        'agent-studio:instance-a:session-1': {
          thinkingLevel: 'low',
          messages: [
            {
              role: 'user',
    ...
    const clientB = new MockGatewayClient(
      {
        ...
        sessions: [
          {
            key: 'agent-studio:instance-b:session-1',
            label: 'B One',
            updatedAt: 150,
            kind: 'direct',
            model: 'OpenClaw B',
      ...
      {
        'agent-studio:instance-b:session-1': {
          thinkingLevel: 'medium',
          messages: [
            {
              role: 'user',
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 300,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-1`;
      },
    });
    ...
    assert.deepEqual(
      ...
      ['agent-studio:instance-a:session-1', 'agent-studio:instance-a:session-2'],
    );
    assert.equal(snapshotA.activeSessionId, 'agent-studio:instance-a:session-1');
    ...
    assert.equal(snapshotB.activeSessionId, 'agent-studio:instance-b:session-1');
    ...
    assert.deepEqual(clientA.sendCalls, [
      {
        sessionKey: 'agent-studio:instance-a:draft-1',
        message: 'stream to A',
        deliver: false,
    ...
    assert.deepEqual(clientA.patchCalls, [
      {
        key: 'agent-studio:instance-a:draft-1',
        label: 'stream to A',
      },
    ]);
    ...
    await store.setSessionModel({
      instanceId: 'instance-a',
      sessionId: 'agent-studio:instance-a:session-1',
      model: 'openai/gpt-4.1',
    });
    snapshotA = store.getSnapshot('instance-a');
    assert.equal(
      snapshotA.sessions.find((session) => session.id === 'agent-studio:instance-a:session-1')?.model,
      'openai/gpt-4.1',
    );
    assert.deepEqual(clientA.patchCalls, [
      {
    ...
    snapshotA = store.getSnapshot('instance-a');
    assert.equal(
      snapshotA.sessions.find((session) => session.id === 'agent-studio:instance-a:session-1')
        ?.thinkingLevel,
      'high',
    );
    assert.deepEqual(clientA.patchCalls, [
    ...
    const remoteSessionId = 'agent-studio:instance-a:session-1';
    ...
    assert.deepEqual(
      store.getSnapshot('instance-a').sessions.map((session) => session.id),
      ['agent-studio:instance-a:draft-1', 'agent-studio:instance-a:session-2'],
    );
  },
);
...
await runTest(
  ...
  async () => {
    const researchThreadSessionId = 'agent:research:main:thread:agent-studio:session-1';
...
await runTest(
  ...
  async () => {
    const threadSessionId = 'agent:research:main:thread:agent-studio:session-1';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
  ...
  async () => {
    const client = new MockGatewayClient(
      {
        ...
        sessions: [
          ...
          {
            key: 'agent-studio:instance-a:session-3',
            updatedAt: 290,
            kind: 'direct',
            model: 'OpenClaw A',
          },
    ...
    assert.deepEqual(
      ...
      [
        ...
        {
          id: 'agent-studio:instance-a:session-3',
          title: 'New Conversation',
          titleSource: 'default',
          lastMessagePreview: null,
        },
    ...
    const client = new MockGatewayClient(
      {
        ...
        sessions: [
          {
            key: 'thread:agent-studio:install-audit',
      ...
      {
        'thread:agent-studio:install-audit': {
          thinkingLevel: 'medium',
          messages: [],
        },
      },
    ...
    const client = new MockGatewayClient(
      {
        ...
        sessions: [
          {
            key: 'agent-studio:instance-a:session-technical-title',
            derivedTitle: 'session-technical-title(2026-04-26)',
            label: 'agent-studio:instance-a:session-technical-title (2026-04-26)',
            updatedAt: 530,
            kind: 'direct',
            model: 'OpenClaw A',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-new-title';
    const client = new MockGatewayClient(
      {
        ts: 1,
...
await runTest(
  ...
  async () => {
    const activeSessionId = 'agent-studio:instance-a:active-readable';
...
await runTest(
  ...
  async () => {
    ...
    assert.deepEqual(client.sendCalls, [
      {
        sessionKey: 'agent-studio:instance-a:session-1',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-1';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    ...
    client.setHistory('agent-studio:instance-a:session-1', {
      thinkingLevel: 'low',
      messages: [
        {
          role: 'user',
    ...
    await waitFor(
      () =>
        store
          .getSnapshot('instance-a')
          .sessions.find((session) => session.id === 'agent-studio:instance-a:session-1')
...
await runTest(
  ...
  async () => {
    const sessionA = 'agent-studio:instance-a:session-1';
    const sessionB = 'agent-studio:instance-a:session-2';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-reused-seq';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionA = 'agent-studio:instance-a:session-active';
    const sessionB = 'agent-studio:instance-a:session-inactive';
    let now = 420;
    const client = new MockGatewayClient(
      {
        ts: 1,
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-seq-order';
    let now = 500;
    const client = new MockGatewayClient(
      {
        ts: 1,
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-history-dedupe';
    const client = new MockGatewayClient(
      {
        ts: 1,
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-live-transcript';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-final-transcript-echo';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-metadata';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-live-metadata';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 600,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-attachment`;
      },
    });
    ...
    assert.deepEqual(client.sendCalls, [
      {
        sessionKey: 'agent-studio:instance-a:draft-attachment',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-inline-image-history';
    const client = new MockGatewayClient(
      {
        ts: 1,
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 700,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-preserve-user`;
      },
    });
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-user-echo-dedup';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  'openclaw gateway session store deduplicates text-only user echoes for local attachment sends',
  async () => {
    const sessionId = 'agent-studio:instance-a:session-user-attachment-echo-dedup';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
        ...
        sessions: [
          {
            key: sessionId,
            label: 'User Attachment Echo Dedup',
            updatedAt: 704,
            kind: 'direct',
            model: 'OpenClaw A',
          },
      ...
      {
        [sessionId]: {
          thinkingLevel: 'attachment-echo-dedup-start',
          messages: [],
        },
      },
    );
    ...
    client.emitSessionMessage({
      sessionKey: sessionId,
      messageId: 'msg-remote-user-attachment-echo',
      senderLabel: 'Iris',
      message: {
        id: 'msg-remote-user-attachment-echo',
        role: 'user',
        senderLabel: 'Iris',
        content: [{ type: 'text', text: 'please inspect this screenshot' }],
        timestamp: 706,
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 715,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-user-history-dedup`;
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 710,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-final-dedup`;
      },
    });
...
await runTest(
  ...
  async () => {
    const sessionA = 'agent-studio:instance-a:session-a';
    const sessionB = 'agent-studio:instance-a:session-b';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 830,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-error-stream`;
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 840,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-abort-partial`;
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 845,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-own-run-non-assistant-final`;
      },
    });
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 860,
      createSessionKey(instanceId) {
        return `agent-studio:${instanceId}:draft-other-run-history-reload`;
      },
    });
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      createSessionKey(instanceId, agentId) {
        ...
        return `agent:${agentId}:main:thread:agent-studio:draft-1`;
      },
    });
    ...
    assert.equal(draft.id, 'agent:research:main:thread:agent-studio:draft-1');
    ...
    assert.deepEqual(client.sendCalls, [
      {
        sessionKey: 'agent:research:main:thread:agent-studio:draft-1',
...
await runTest(
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      now: () => 715,
      createSessionKey(instanceId, agentId) {
        return `agent:${agentId}:main:thread:agent-studio:${instanceId}:draft-empty-model`;
      },
    });
    ...
    assert.equal(draft.id, 'agent:research:main:thread:agent-studio:instance-a:draft-empty-model');
  ...
  async () => {
    ...
    const store = new OpenClawGatewaySessionStore({
      ...
      createSessionKey(instanceId, _agentId) {
        return `agent-studio:${instanceId}:should-not-be-used`;
      },
    });
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-sender-labels';
    const client = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
...
await runTest(
  ...
  async () => {
    const sessionId = 'agent-studio:instance-a:session-release';
    const clientA = new MockGatewayClient(
      {
        ts: 1,
        path: 'sessions-a.json',
