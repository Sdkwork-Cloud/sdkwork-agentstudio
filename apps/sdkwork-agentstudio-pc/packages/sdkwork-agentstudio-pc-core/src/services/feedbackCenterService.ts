...
type FeedbackCenterClient = { feedback: import('../sdk/appSdkPort.ts').agentstudioFeedbackClient };
...
function getDefaultClient(): FeedbackCenterClient {
  return getagentstudioAppClientWithSession() as FeedbackCenterClient;
}
