...
This directory is the local standards index for `sdkwork-claw-host-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-host-core` |
| Type | `rust-crate` |
| Root | `claw-studio/packages/sdkwork-claw-host-core/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/claw-studio/packages/sdkwork-claw-host-core/src-host/Cargo.toml`
