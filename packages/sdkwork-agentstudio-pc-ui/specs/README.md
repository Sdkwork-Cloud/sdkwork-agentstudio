# SDKWork Claw UI Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-ui`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-ui` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-ui` |
| Domain | `platform` |
