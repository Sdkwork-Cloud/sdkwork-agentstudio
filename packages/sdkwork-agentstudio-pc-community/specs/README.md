# SDKWork Claw Community Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-community`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-community` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-community` |
