# SDKWork Claw Desktop Component Specs

This directory is the local standards index for `sdkwork-agentstudio-pc-desktop`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-agentstudio-pc-desktop` |
| Type | `tauri-host` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-desktop/src-tauri` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/agent-studio/packages/sdkwork-agentstudio-pc-desktop/src-tauri/Cargo.toml`
