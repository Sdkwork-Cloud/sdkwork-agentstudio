# SDKWork Claw Auth Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-auth`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-auth` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-auth` |
| Domain | `iam` |
| Capability | `auth` |
