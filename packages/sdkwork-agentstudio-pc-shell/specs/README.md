# SDKWork Claw Shell Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-shell` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-shell` |
| Domain | `platform` |
| Capability | `shell` |
