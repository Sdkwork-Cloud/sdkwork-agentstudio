# SDKWork Claw Commons Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-commons` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-commons` |
| Domain | `platform` |
