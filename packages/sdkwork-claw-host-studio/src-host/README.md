...
This README is the SDKWork module entrypoint for `sdkwork-claw-host-studio`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/claw-studio/packages/sdkwork-claw-host-studio/src-host/Cargo.toml`
