# SDKWork Claw Server Component Specs

This directory is the local standards index for `sdkwork-agentstudio-pc-server`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-agentstudio-pc-server` |
| Type | `rust-crate` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-server/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/agent-studio/packages/sdkwork-agentstudio-pc-server/src-host/Cargo.toml`
