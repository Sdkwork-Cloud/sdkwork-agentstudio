...
This directory is the local standards index for `sdkwork-claw-desktop`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-desktop` |
| Type | `tauri-host` |
| Root | `claw-studio/packages/sdkwork-claw-desktop/src-tauri` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/claw-studio/packages/sdkwork-claw-desktop/src-tauri/Cargo.toml`
