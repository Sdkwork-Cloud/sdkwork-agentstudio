...
This directory is the local standards index for `@sdkwork/claw-infrastructure`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/claw-infrastructure` |
| Type | `node-package` |
| Root | `claw-studio/packages/sdkwork-claw-infrastructure` |
| Domain | `platform` |
