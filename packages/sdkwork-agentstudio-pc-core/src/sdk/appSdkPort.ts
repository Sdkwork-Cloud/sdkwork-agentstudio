...
export interface agentstudioSkillClient {
...
export interface agentstudioRemoteAppClient extends SdkworkAppClient {
  account?: unknown;
  category?: unknown;
  comment?: unknown;
  feedback?: agentstudioFeedbackClient;
  feed?: unknown;
  order?: agentstudioOrderClient;
  product?: agentstudioProductClient;
  skill?: agentstudioSkillClient;
  user?: unknown;
}
