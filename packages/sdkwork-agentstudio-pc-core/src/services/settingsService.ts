import { storage, type StoragePlatformAPI } from '@sdkwork/agentstudio-pc-infrastructure';
...
const SETTINGS_STORAGE_NAMESPACE = 'agent-studio-settings';
const SETTINGS_OVERLAY_STORAGE_KEY = 'preferences-overlay';
const LEGACY_SETTINGS_OVERLAY_STORAGE_KEY = 'agent-studio-settings-overlay';
...
async function getDefaultSettingsClient(): Promise<SettingsSdkClient> {
  ...
  return getagentstudioAppClientWithSession() as unknown as SettingsSdkClient;
}
