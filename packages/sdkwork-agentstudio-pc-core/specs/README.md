...
This directory is the local standards index for `@sdkwork/agentstudio-pc-core`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-core` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-core` |
| Domain | `platform` |
