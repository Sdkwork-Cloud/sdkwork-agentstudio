...
const sampleRequest: AppUpdateCheckRequest = {
  ...
  packageName: 'agent-studio',
  bundleId: 'com.sdkwork.agent-studio',
  deviceId: 'device-1',
              ...
              data: {
                ...
                updateUrl:
                  request.currentVersion === '0.1.0'
                    ? 'https://downloads.sdkwork.com/agent-studio-0.2.0'
                    : undefined,
                ...
                resolvedPackage:
                  request.currentVersion === '0.1.0'
                    ? {
                        url: 'https://downloads.sdkwork.com/agent-studio-0.2.0.exe',
                        packageFormat: 'nsis',
                        architecture: 'x86_64',
                      }
                    : undefined,
...
await runTest('checkAppUpdate never applies browser root tokens to the generated sdk client', async () => {
  ...
  assert.equal(result.resolvedPackage?.url, 'https://downloads.sdkwork.com/agent-studio-0.2.0.exe');
});
