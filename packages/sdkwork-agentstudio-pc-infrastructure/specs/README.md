# SDKWork Claw Infrastructure Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-infrastructure`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-infrastructure` |
| Type | `node-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-infrastructure` |
| Domain | `platform` |
