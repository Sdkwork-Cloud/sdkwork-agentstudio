# SDKWork Claw Web Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-web`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-web` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-web` |
| Domain | `platform` |
