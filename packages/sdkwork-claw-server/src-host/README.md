...
This README is the SDKWork module entrypoint for `sdkwork-claw-server`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/claw-studio/packages/sdkwork-claw-server/src-host/Cargo.toml`
