# SDKWork Claw Types Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-types` |
| Type | `node-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-types` |
| Domain | `platform` |
