# SDKWork Claw Chat Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-chat`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-chat` |
| Type | `react-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-chat` |
