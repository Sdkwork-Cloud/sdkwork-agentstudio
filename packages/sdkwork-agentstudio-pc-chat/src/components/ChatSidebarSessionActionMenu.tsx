...
export interface ChatSidebarSessionActionMenuProps {
  open: boolean;
  sections: ChatSidebarSessionActionsPresentation['sections'];
  anchorRect?: FloatingAnchorRect | null;
  anchorPoint?: FloatingAnchorPoint | null;
  closeLabel: string;
  restoreFocusElement?: HTMLElement | null;
  onClose: () => void;
  onSelectAction: (actionId: ChatSidebarSessionActionId) => void;
}

function resolveActionIcon(actionId: ChatSidebarSessionActionId) {
  switch (actionId) {
    case 'favorite':
      return Bookmark;
    case 'pin':
...
export function ChatSidebarSessionActionMenu({
  open,
  sections,
  anchorRect = null,
  anchorPoint = null,
  ...
  onClose,
  onSelectAction,
}: ChatSidebarSessionActionMenuProps) {
  ...
  return createPortal(
    <>
      ...
      />
      <div
        id="chat-sidebar-session-actions-menu"
        ref={menuRef}
        role="menu"
