# SDKWork Claw Tasks Component Specs

This directory is the local standards index for `@sdkwork/agentstudio-pc-tasks`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agentstudio-pc-tasks` |
| Type | `node-package` |
| Root | `agent-studio/packages/sdkwork-agentstudio-pc-tasks` |
| Domain | `platform` |
