...
This directory is the local standards index for `@sdkwork/claw-distribution`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/claw-distribution` |
| Type | `node-package` |
| Root | `claw-studio/packages/sdkwork-claw-distribution` |
| Domain | `device` |
