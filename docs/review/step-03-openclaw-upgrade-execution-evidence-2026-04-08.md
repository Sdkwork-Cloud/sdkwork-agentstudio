...
- Actual workspace result:
  ...
  - the owner reports that both `packages/sdkwork-agentstudio-pc-desktop/src-tauri/target` and `packages/sdkwork-agentstudio-pc-desktop/.tauri-target` are clean
