...
- Extended `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentSkillMutationSupport.ts` to also own:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1906`
