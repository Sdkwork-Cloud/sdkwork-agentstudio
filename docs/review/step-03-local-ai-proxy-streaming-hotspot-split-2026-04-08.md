...
- Root cause:
  - `packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` still mixed request-serving with streaming request detection, passthrough streaming response construction, SSE/JSONL translation, and Anthropic/Gemini/Ollama stream-frame handling in the same runtime hotspot.
...
- Implemented the narrow repair:
  - added `packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/local_ai_proxy/streaming.rs`
...
- `cargo test --manifest-path packages/sdkwork-clawstudio-desktop/src-tauri/Cargo.toml --target-dir target/step03-cp032-streaming local_ai_proxy_`
