...
- Added `packages/sdkwork-clawstudio-instances/src/services/instanceDetailAgentSkillMutationSupport.ts`.
...
- Added focused direct coverage in `packages/sdkwork-clawstudio-instances/src/services/instanceDetailAgentSkillMutationSupport.test.ts`.
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1006` lines / `40621` bytes
- `packages/sdkwork-clawstudio-instances/src/services/instanceDetailAgentSkillMutationSupport.ts`: `19` lines / `957` bytes
- `packages/sdkwork-clawstudio-instances/src/services/instanceDetailAgentSkillMutationSupport.test.ts`: `50` lines / `1813` bytes
...
- RED:
  - `node --experimental-strip-types packages/sdkwork-clawstudio-instances/src/services/instanceDetailAgentSkillMutationSupport.test.ts`
