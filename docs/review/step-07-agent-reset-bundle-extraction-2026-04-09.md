...
- Added to `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentPresentation.ts`:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1498`
