...
- Extracted dedicated Instance Detail render components:
  ...
  - `packages/sdkwork-agentstudio-pc-instances/src/components/InstanceDetailSkillsSection.tsx`
  ...
  - `packages/sdkwork-agentstudio-pc-instances/src/components/InstanceDetailLlmProviderDialogs.tsx`
  - `packages/sdkwork-agentstudio-pc-instances/src/components/InstanceDetailManagedLlmProvidersSection.tsx`
...
- Extracted pure helper layers:
  ...
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderConfigPatch.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigPathFallback.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawFilePathSupport.ts`
...
- Added focused helper coverage:
  ...
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.test.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.test.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderConfigPatch.test.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigPathFallback.test.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawFilePathSupport.test.ts`
...
- Fresh current hotspots still blocking formal closure:
  - `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2792`
  - `handleSubmitProviderModelDialog` inside `InstanceDetail.tsx`
  - `handleSubmitProviderDialog` inside `InstanceDetail.tsx`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `3693`
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `2924`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.ts`: `289`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.ts`: `206`
...
- Added focused coverage for both new helpers in:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.test.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentWorkbenchSupport.test.ts`
- Rewired `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` so channel mapping/clone/merge and agent mapping/clone/normalize/merge/build-managed logic no longer live inline in the core hotspot.
- Updated `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts` so the new helper boundaries are exported through the service barrel.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `2635`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.ts`: `289`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.ts`: `206`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.ts`: `101`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentWorkbenchSupport.ts`: `216`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `2635` lines.
...
- Added focused coverage in:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.test.ts`
- Rewired `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` so the following pure logic no longer lives inline in the service-core hotspot:
...
- Updated `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts` so the new managed-config helper boundary is exported through the service barrel.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `2462`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.ts`: `289`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.ts`: `206`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.ts`: `101`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentWorkbenchSupport.ts`: `216`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.ts`: `207`
...
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigDrafts.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.test.ts`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `2462` lines.
...
- The largest unresolved hotspot in the active Step 07 slice is now:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `2924` lines
...
- Added focused coverage in:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkbenchSupport.test.ts`
- Rewired `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` so the following pure provider shaping logic no longer lives inline in the service-core hotspot:
...
- Updated `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts` so the new provider helper boundary is exported through the service barrel.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `2379`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.ts`: `289`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.ts`: `206`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.ts`: `101`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentWorkbenchSupport.ts`: `216`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.ts`: `207`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkbenchSupport.ts`: `111`
...
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkbenchSupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigDrafts.test.ts`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `2379` lines.
...
- Extracted shared OpenClaw skill workbench shaping ownership into:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawSkillWorkbenchSupport.ts`
- Extracted shared OpenClaw tool workbench shaping ownership into:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawToolWorkbenchSupport.ts`
- Added focused coverage in:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawSkillWorkbenchSupport.test.ts`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawToolWorkbenchSupport.test.ts`
- Rewired `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` so the following pure shaping logic no longer lives inline in the service-core hotspot:
...
- Updated `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts` so both new helper boundaries are exported through the service barrel.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `2361`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.ts`: `289`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.ts`: `206`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.ts`: `101`
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.ts`: `207`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkbenchSupport.ts`: `111`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawSkillWorkbenchSupport.ts`: `55`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawToolWorkbenchSupport.ts`: `186`
...
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawToolWorkbenchSupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchService.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigSchemaSupport.test.ts`
- `node --experimental-strip-types scripts/sdkwork-instances-contract.test.ts`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `2361` lines.
...
- Added focused coverage in:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/openClawFileWorkbenchSupport.test.ts`
- Rewired `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` so the following pure file/memory shaping logic no longer lives inline in the service-core hotspot:
...
- Updated `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts` so the new file helper boundary is exported through the service barrel.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `2192`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawTaskNormalization.ts`: `289`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawRuntimeMemorySupport.ts`: `206`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.ts`: `101`
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawSkillWorkbenchSupport.ts`: `55`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawToolWorkbenchSupport.ts`: `186`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawFileWorkbenchSupport.ts`: `188`
...
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawFileWorkbenchSupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchService.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts`
- `node --experimental-strip-types scripts/sdkwork-instances-contract.test.ts`
- `pnpm.cmd check:sdkwork-instances`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `2192` lines.
...
- Added focused coverage in:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/instanceRegistryWorkbenchSupport.test.ts`
- Rewired `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` so the following pure registry-backed detail projection logic no longer lives inline in the service-core hotspot:
  ...
  - `isLoopbackHost`
- Updated `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts` so the new helper boundary is exported through the service barrel.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1675`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceRegistryWorkbenchSupport.ts`: `365`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigWorkbenchSupport.ts`: `207`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.ts`: `101`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentWorkbenchSupport.ts`: `216`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkbenchSupport.ts`: `111`
...
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/instanceRegistryWorkbenchSupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchService.test.ts`
- `node --experimental-strip-types scripts/sdkwork-instances-contract.test.ts`
- `pnpm.cmd check:sdkwork-instances`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `1675` lines.
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts` now exports the snapshot helper through the service barrel so the new boundary remains consumable from the package root.
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchSnapshotSupport.test.ts` now provides focused helper coverage for:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1209`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchSnapshotSupport.ts`: `498`
...
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchSnapshotSupport.test.ts`
- `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchService.test.ts`
- `node --experimental-strip-types scripts/sdkwork-instances-contract.test.ts`
- `pnpm.cmd check:sdkwork-instances`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `1209` lines.
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.test.ts` now verifies:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2553`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1030`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawChannelWorkbenchSupport.ts`: `290`
...
- `CP07-3` remains open.
- The page hotspot remains `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` at `2553` lines.
- The largest remaining service hotspot is now `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` at `1030` lines.
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts` now tags page-facing provider submit plans with explicit action kinds:
  - `providerCreate`
  - `providerModelCreate`
  - `providerModelUpdate`
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` now routes both provider submit handlers through a shared page-owned `runProviderCatalogMutation(...)` runner instead of duplicating save, error, and post-success orchestration in each handler.
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.test.ts` now enforces the new action-kind metadata for the page shell.
...
- `packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts` still proves browser-backed workbench detail preserves provider edits after save.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagementCapabilities.ts` still derives managed OpenClaw authority from `workbenchManaged` or writable managed config routes.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkspacePresentation.ts` still keeps `canManageProviderCatalog: false` for OpenClaw details.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigSchemaSupport.test.ts` still preserves Control UI section order.
- `packages/sdkwork-agentstudio-pc-channels/src/services/channelService.ts` still owns managed channel writes through config service or studio bridge.
- `packages/sdkwork-agentstudio-pc-market/src/services/marketService.ts` still owns skill/package discovery and install entry points.
- `packages/sdkwork-agentstudio-pc-agent/src/services/agentInstallService.ts` still resolves agent install/workspace plans from OpenClaw config-backed paths.
- `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` still owns the local proxy `chat/completions`, `responses`, Anthropic, Gemini, and Ollama protocol surface.
- `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/plugins/mod.rs` still only registers desktop plugin bootstrap.

### Fresh Measurements After Provider Submit Runner Extraction

- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2803`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1132`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1431`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `345`
...
- `CP07-3` remains open.
- The page hotspot is still the dominant frontier at `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` with a fresh current-worktree measurement of `2803` lines.
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts` now also owns page-facing delete mutation metadata for:
  - `providerModelDelete`
  - `providerDelete`
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` now routes the following flows through the same page-owned `runProviderCatalogMutation(...)` runner:
  - provider create
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.test.ts` now verifies the new delete mutation metadata.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2816`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1132`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1431`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `396`
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts` now owns:
  - `buildOpenClawProviderConfigSaveInput(...)`
  - `buildOpenClawProviderConfigMutationPlan(...)`
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` now routes `handleSaveProviderConfig` through the same page-owned `runProviderCatalogMutation(...)` runner as the other provider catalog mutations.
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.test.ts` now verifies the provider config save-input and mutation-plan boundary.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2827`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `461`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1132`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1431`
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts` now also owns pure provider draft derivation helpers:
  - `createOpenClawProviderConfigDraft(...)`
  - `createOpenClawProviderRequestDraft(...)`
  - `hasPendingOpenClawProviderConfigChanges(...)`
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` now consumes those helpers for:
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.test.ts` now verifies cloned baseline behavior, request baseline derivation, and pending-change detection.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2810`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `510`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1132`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1431`
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts` now also owns pure page-facing draft-map mutation helpers:
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.test.ts` now verifies that field/config/request draft updates clone the page-owned draft maps and preserve the existing optional-model clearing behavior.
...
- `packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts` still proves browser-backed workbench detail persists provider edits.
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceService.test.ts` still rejects config-backed and built-in managed OpenClaw provider catalog writes outside Provider Center.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagementCapabilities.ts` and `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkspacePresentation.ts` still keep managed-provider authority and read-only classification outside the page.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigSchemaSupport.test.ts` still preserves Control UI section order.
- `packages/sdkwork-agentstudio-pc-channels/src/services/channelService.ts`, `packages/sdkwork-agentstudio-pc-market/src/services/marketService.ts`, and `packages/sdkwork-agentstudio-pc-agent/src/services/agentInstallService.ts` remain the external feature owners for channel writes, market installs, and agent workspace materialization.
- `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` and `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/plugins/mod.rs` remain the Local Proxy and desktop plugin/runtime boundary.

### Fresh Measurements After Provider Draft Mutation Helper Extraction

- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2811`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `561`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1132`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1431`
...
- `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailWorkbenchPresentation.ts` now owns the pure page-facing workbench presentation layer for:
  - `workbenchSections`
  - `getRuntimeStatusTone(...)`
  - `getStatusBadge(...)`
  - `getDangerBadge(...)`
  - `buildTaskScheduleSummary(...)`
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` now imports that dedicated presentation module instead of keeping the section metadata, badge-tone mapping, and task schedule summary formatting inline.
- This loop intentionally kept the authority split unchanged:
  ...
  - no `instanceService.*`, `toast.*`, `loadWorkbench(...)`, Provider Center managed classification, Local Proxy routing, or desktop plugin/runtime boundary moved
- `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailWorkbenchPresentation.test.ts` now verifies:
...
- `packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts` still proves browser-backed workbench detail persists provider edits and managed channel writes.
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceService.test.ts` still keeps Provider Center authority and remote OpenClaw provider routing outside the presentation layer.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagementCapabilities.ts` and `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkspacePresentation.ts` still keep managed-provider authority and read-only classification outside the page presentation module.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigSchemaSupport.test.ts` still preserves Control UI section order.
- `packages/sdkwork-agentstudio-pc-channels/src/services/channelService.ts`, `packages/sdkwork-agentstudio-pc-market/src/services/marketService.ts`, and `packages/sdkwork-agentstudio-pc-agent/src/services/agentInstallService.ts` remain the external feature owners for channel writes, market installs, and agent workspace materialization.
- `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` and `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/plugins/mod.rs` remain the Local Proxy and desktop plugin/runtime boundary.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2640`
- `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailWorkbenchPresentation.ts`: `183`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `561`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1132`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1431`
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigDrafts.ts` now also owns the pure managed-config form-state factory layer for:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` now consumes those helpers and their shared draft-value types through import aliases instead of keeping:
...
- This loop intentionally kept the page authority split unchanged:
  ...
  - no `instanceService.*`, `toast.*`, `loadWorkbench(...)`, Provider Center managed classification, Local Proxy routing, or desktop plugin/runtime boundary moved
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigDrafts.test.ts` now verifies:
...
- `packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts` still proves browser-backed workbench detail persists provider edits and managed channel writes.
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceService.test.ts` still keeps Provider Center authority, managed config writes, and remote OpenClaw provider routing outside the new draft-factory layer.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagementCapabilities.ts` and `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkspacePresentation.ts` still keep managed-provider authority and read-only classification outside the page.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigSchemaSupport.test.ts` still preserves Control UI section order.
- `packages/sdkwork-agentstudio-pc-channels/src/services/channelService.ts`, `packages/sdkwork-agentstudio-pc-market/src/services/marketService.ts`, and `packages/sdkwork-agentstudio-pc-agent/src/services/agentInstallService.ts` remain the external feature owners for channel writes, market installs, and agent workspace materialization.
- `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` and `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/plugins/mod.rs` remain the Local Proxy and desktop plugin/runtime boundary.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2474`
- `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailWorkbenchPresentation.ts`: `183`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigDrafts.ts`: `506`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `561`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1132`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1431`
...
- `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailWorkbenchPresentation.ts` now also owns the pure overview presentation helpers:
  - `getCapabilityTone(...)`
  - `getManagementEntryTone(...)`
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` now imports those helpers from the presentation module instead of keeping the capability and management-entry tone mapping inline at the top of the page.
...
- `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailWorkbenchPresentation.test.ts` now verifies the extracted tone boundary directly, including:
...
- `packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts` still proves browser-backed workbench detail persists OpenClaw tasks, files, provider edits, and managed channel writes through the real bridge.
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceService.test.ts` still keeps Provider Center authority, managed config writes, and remote OpenClaw provider routing outside the presentation boundary.
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagementCapabilities.ts` and `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkspacePresentation.ts` still keep managed-provider authority and editability classification outside the page-top tone helpers.
- `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` and `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/plugins/mod.rs` remain the Local Proxy and desktop plugin/runtime boundary.

### Fresh Measurements After Tone Helper Extraction

- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `2242`
- `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailWorkbenchPresentation.ts`: `195`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigDrafts.ts`: `455`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderDrafts.ts`: `511`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `1030`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1274`
