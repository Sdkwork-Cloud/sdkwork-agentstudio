> Migrated from `docs/review/step-03-kernel-center-startup-evidence-built-in-default-flags-convergence-2026-04-08.md` on 2026-06-24.
...
- `cargo test --manifest-path packages/sdkwork-clawstudio-desktop/src-tauri/Cargo.toml --target-dir target/step03-cp034-startup-evidence-built-in-default-red desktop_kernel_info_exposes_persisted_startup_evidence_summary`
