...
- Added `packages/sdkwork-clawstudio-instances/src/services/openClawChannelPresentation.ts` with:
...
- Added focused helper coverage in:
  - `packages/sdkwork-clawstudio-instances/src/services/openClawChannelPresentation.test.ts`
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1460`
- `packages/sdkwork-clawstudio-instances/src/services/openClawChannelPresentation.ts`: `12`
