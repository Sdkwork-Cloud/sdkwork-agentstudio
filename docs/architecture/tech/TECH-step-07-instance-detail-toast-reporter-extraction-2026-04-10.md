...
- Added focused direct coverage in `packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailToastSupport.test.ts`.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1064` lines / `41287` bytes
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailToastSupport.ts`: `17` lines / `579` bytes
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailToastSupport.test.ts`: `53` lines / `1474` bytes
