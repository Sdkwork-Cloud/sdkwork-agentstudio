> Migrated from `docs/step/2026-04-07-openclaw-task-flow-requester-origin-parity.md` on 2026-06-24.
...
3. `packages/sdkwork-agentstudio-pc-commons/src/components/taskRuntimeFlowMeta.test.ts`
...
- the build failure remains environmental and happened while pnpm's installer was copying dependencies into
  `node_modules`
