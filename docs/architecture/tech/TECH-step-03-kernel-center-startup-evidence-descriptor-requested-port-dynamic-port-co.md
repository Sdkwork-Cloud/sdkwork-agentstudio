> Migrated from `docs/review/step-03-kernel-center-startup-evidence-descriptor-requested-port-dynamic-port-convergence-2026-04-08.md` on 2026-06-24.
...
- `cargo test --manifest-path packages/sdkwork-clawstudio-desktop/src-tauri/Cargo.toml --target-dir target/step03-cp034-startup-evidence-descriptor-requested-port-red desktop_kernel_info_exposes_persisted_startup_evidence_summary`
