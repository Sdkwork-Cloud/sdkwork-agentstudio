...
- Extended `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedChannelMutationSupport.ts` with:
...
- Rewired `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` to:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1504`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedChannelMutationSupport.ts`: `275`
