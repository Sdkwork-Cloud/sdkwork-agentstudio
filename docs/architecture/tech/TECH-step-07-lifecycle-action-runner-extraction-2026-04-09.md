...
- Added `packages/sdkwork-agentstudio-pc-instances/src/services/instanceLifecycleActionSupport.ts` to own:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1911`
