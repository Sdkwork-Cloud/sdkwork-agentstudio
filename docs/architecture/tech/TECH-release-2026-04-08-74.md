...
- Reduced the recorded `packages/sdkwork-clawstudio-instances/src/services/instanceWorkbenchServiceCore.ts` hotspot from the prior `2379`-line baseline to a fresh `2361` lines while keeping OpenClaw authority unchanged.
