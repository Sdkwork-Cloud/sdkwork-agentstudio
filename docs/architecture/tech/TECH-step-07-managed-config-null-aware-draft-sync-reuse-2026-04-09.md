> Migrated from `docs/review/step-07-managed-config-null-aware-draft-sync-reuse-2026-04-09.md` on 2026-06-24.
...
- Updated `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx` so the page now:
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1490`
