...
- Reduced the service-core frontier on fresh measurement:
  - `packages/sdkwork-agentstudio-pc-instances/src/services/instanceServiceCore.ts`: `1663 -> 1431`
  - `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts`: `3818 -> 3797`
