...
- Reduced the recorded `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` hotspot from the prior `2462`-line baseline to a fresh `2379` lines while keeping OpenClaw authority unchanged.
