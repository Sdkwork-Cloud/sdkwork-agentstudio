...
- Reduced the full `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` hotspot from `2635` to `2618` lines on fresh measurement, and removed the former provider/agent render wrappers from the hotspot frontier.
