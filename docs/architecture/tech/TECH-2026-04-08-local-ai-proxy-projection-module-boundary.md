...
- `packages/sdkwork-clawstudio-desktop/src-tauri/src/plugins/mod.rs` remains host-plugin registration only, so projection logic cannot be hidden in plugin bootstrap side effects.
