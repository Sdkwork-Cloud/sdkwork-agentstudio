> Migrated from `docs/架构/103-2026-04-08-local-ai-proxy-projection-module-boundary.md` on 2026-06-24.
...
- `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/plugins/mod.rs` remains host-plugin registration only, so projection logic cannot be hidden in plugin bootstrap side effects.
