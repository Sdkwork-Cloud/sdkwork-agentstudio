...
- Extended `packages/sdkwork-clawstudio-instances/src/services/openClawAgentSkillMutationSupport.ts` to also own:
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1906`
