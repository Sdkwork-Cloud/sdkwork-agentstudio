...
# Agent Studio release-2026-04-09-128
...
- Implemented the Step 07 extraction:
  ...
  - rewired `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` so the page now consumes `findOpenClawManagedChannelById(...)`
