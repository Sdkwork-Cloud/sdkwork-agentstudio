...
Appbase login, registration, session refresh, logout, OAuth, QR auth, password reset, and verification-code flows are no longer classified as raw HTTP. `packages/sdkwork-clawstudio-core/src/services/appAuthService.ts` delegates to `@sdkwork/auth-pc-react/auth-service`, `@sdkwork/iam-app-sdk`, and `@sdkwork/messaging-app-sdk`.

## Fixed SDKWork API Bypasses

`packages/sdkwork-clawstudio-core/src/services/appAuthService.ts`
...
`packages/sdkwork-clawstudio-core/src/sdk/appSdkPort.ts`
...
`packages/sdkwork-clawstudio-core/src/services/accountService.ts`
...
`packages/sdkwork-clawstudio-core/src/services/settingsService.ts`
...
`packages/sdkwork-clawstudio-core/src/lib/llmService.ts`
...
`packages/sdkwork-clawstudio-chat/src/services/chatService.ts`
...
`packages/sdkwork-clawstudio-infrastructure/src/platform/web.ts`
...
`packages/sdkwork-clawstudio-infrastructure/src/http/httpClient.ts`
...
- `packages/sdkwork-clawstudio-core/src/services/accountService.test.ts`
...
- `packages/sdkwork-clawstudio-infrastructure/src/updates/updateClient.test.ts`
