...
- Added `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedChannelPresentation.ts` with:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1494`
