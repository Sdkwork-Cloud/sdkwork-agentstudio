> Migrated from `docs/review/step-03-local-ai-proxy-config-hotspot-split-2026-04-08.md` on 2026-06-24.
...
- Root cause:
  - `packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` still mixed control-plane config loading, public-host normalization, loopback-safety resolution, proxy lifecycle, and request-serving logic in the same runtime hotspot.
