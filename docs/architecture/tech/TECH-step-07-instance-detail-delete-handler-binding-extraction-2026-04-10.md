> Migrated from `docs/review/step-07-instance-detail-delete-handler-binding-extraction-2026-04-10.md` on 2026-06-24.
...
- Added focused direct coverage in `packages/sdkwork-clawstudio-instances/src/services/instanceDetailDeleteSupport.test.ts`.
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1072` lines / `40290` bytes
- `packages/sdkwork-clawstudio-instances/src/services/instanceDetailDeleteSupport.ts`: `23` lines / `769` bytes
- `packages/sdkwork-clawstudio-instances/src/services/instanceDetailDeleteSupport.test.ts`: `61` lines / `1678` bytes
