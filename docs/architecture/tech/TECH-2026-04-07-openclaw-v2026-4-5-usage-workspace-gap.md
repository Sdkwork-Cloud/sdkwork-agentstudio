> Migrated from `docs/step/2026-04-07-openclaw-v2026-4-5-usage-workspace-gap.md` on 2026-06-24.
...
Close the next real OpenClaw parity gap in local `agent-studio`: the shared `usage` workspace.

This loop kept the host architecture unified:

- business logic in `packages/sdkwork-agentstudio-pc-dashboard`
- shell wiring in `packages/sdkwork-agentstudio-pc-shell`
- locale wiring in `packages/sdkwork-agentstudio-pc-i18n`
...
The partially written `packages/sdkwork-agentstudio-pc-dashboard/src/pages/UsageWorkspace.tsx` also left the workspace uncompilable.
...
- `sdkwork-agentstudio-pc-dashboard` imported `@sdkwork/agentstudio-pc-i18n` but did not declare it.

Fix:

- added `@sdkwork/agentstudio-pc-i18n` to `packages/sdkwork-agentstudio-pc-dashboard/package.json`
...
- `sync:locales` and `packages/sdkwork-agentstudio-pc-i18n/src/index.test.ts` were first run in parallel
...
- `packages/sdkwork-agentstudio-pc-dashboard/src/Usage.tsx`
...
- `packages/sdkwork-agentstudio-pc-dashboard/src/services/usageWorkspaceService.test.ts`
- `packages/sdkwork-agentstudio-pc-dashboard/src/types/index.ts`
- `packages/sdkwork-agentstudio-pc-dashboard/src/types/usage.ts`
...
4. keep every addition inside `sdkwork-agentstudio-pc-dashboard` and shared shell surfaces only
