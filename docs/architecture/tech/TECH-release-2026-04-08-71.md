...
- Reduced the recorded `packages/sdkwork-clawstudio-instances/src/services/instanceWorkbenchServiceCore.ts` hotspot from the prior `2924`-line baseline to a fresh `2635` lines while keeping OpenClaw authority unchanged.
