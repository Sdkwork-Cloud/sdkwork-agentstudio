...
- 波次 B：`pnpm.cmd check:sdkwork-settings` `pnpm.cmd check:sdkwork-chat` `pnpm.cmd check:sdkwork-instances` `pnpm.cmd check:sdkwork-market` `pnpm.cmd check:sdkwork-channels` `node --experimental-strip-types packages/sdkwork-agentstudio-pc-infrastructure/src/platform/webStudio.test.ts` `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/openClawConfigSchemaSupport.test.ts` `node --experimental-strip-types packages/sdkwork-agentstudio-pc-channels/src/services/channelService.test.ts` `node --experimental-strip-types packages/sdkwork-agentstudio-pc-market/src/services/marketService.test.ts` `node --experimental-strip-types packages/sdkwork-agentstudio-pc-agent/src/services/agentInstallService.test.ts`
