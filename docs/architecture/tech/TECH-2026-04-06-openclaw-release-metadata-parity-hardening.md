...
- `packages/sdkwork-agentstudio-pc-types/src/openclawRelease.ts` did not expose it to the
...
- `packages/sdkwork-agentstudio-pc-types/src/openclawRelease.ts`
...
- the contract now asserts:
  ...
  - `packages/sdkwork-agentstudio-pc-types/src/openclawRelease.ts` projects the field
  - `packages/sdkwork-agentstudio-pc-desktop/src-tauri/resources/openclaw/manifest.json`
