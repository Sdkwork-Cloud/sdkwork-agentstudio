...
- Implemented the Step 07 extraction:
  - added `packages/sdkwork-clawstudio-instances/src/services/openClawChannelPresentation.ts`
  - added `packages/sdkwork-clawstudio-instances/src/services/openClawChannelPresentation.test.ts`
  - updated `packages/sdkwork-clawstudio-instances/src/services/index.ts`
  - rewired `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx` so the page now consumes `buildReadonlyChannelWorkspaceItems(...)`
