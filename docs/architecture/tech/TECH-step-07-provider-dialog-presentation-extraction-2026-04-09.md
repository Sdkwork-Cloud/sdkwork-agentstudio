> Migrated from `docs/review/step-07-provider-dialog-presentation-extraction-2026-04-09.md` on 2026-06-24.
...
- Extended `packages/sdkwork-clawstudio-instances/src/services/openClawProviderPresentation.ts`, which now owns:
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1647`
