...
# Agent Studio release-2026-04-09-123
...
- Implemented the Step 07 extraction:
  ...
  - updated `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderWorkspacePresentation.test.ts`
  - rewired `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` so the page now consumes `buildOpenClawProviderWorkspaceSyncState(...)`
