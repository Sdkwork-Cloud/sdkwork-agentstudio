...
- Added focused direct coverage in `packages/sdkwork-clawstudio-instances/src/services/instanceDetailManagedChannelMutationSupport.test.ts`.
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1063` lines / `40328` bytes
- `packages/sdkwork-clawstudio-instances/src/services/instanceDetailManagedChannelMutationSupport.ts`: `22` lines / `983` bytes
- `packages/sdkwork-clawstudio-instances/src/services/instanceDetailManagedChannelMutationSupport.test.ts`: `53` lines / `1748` bytes
