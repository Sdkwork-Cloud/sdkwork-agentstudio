> Migrated from `docs/review/step-07-managed-web-search-draft-state-extraction-2026-04-09.md` on 2026-06-24.
...
- `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx`: `1554`
- `packages/sdkwork-clawstudio-instances/src/services/openClawManagedConfigDrafts.ts`: `499`
