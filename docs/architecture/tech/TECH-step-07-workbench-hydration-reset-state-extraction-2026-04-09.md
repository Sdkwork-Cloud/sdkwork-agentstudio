> Migrated from `docs/review/step-07-workbench-hydration-reset-state-extraction-2026-04-09.md` on 2026-06-24.
...
- Added to `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchHydration.ts`:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1496`
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchHydration.ts`: `101`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedChannelPresentation.ts`: `24`
