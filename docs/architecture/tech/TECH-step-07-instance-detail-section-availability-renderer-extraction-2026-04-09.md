> Migrated from `docs/review/step-07-instance-detail-section-availability-renderer-extraction-2026-04-09.md` on 2026-06-24.
...
- Added `packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailSectionAvailabilitySupport.ts`.
...
- Added focused direct coverage in `packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailSectionAvailabilitySupport.test.ts`.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `994` lines / `41068` bytes
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailSectionAvailabilitySupport.ts`: `30` lines / `1309` bytes
- `packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailSectionAvailabilitySupport.test.ts`: `68` lines / `2481` bytes
...
- RED:
  - `node --experimental-strip-types packages/sdkwork-agentstudio-pc-instances/src/services/instanceDetailSectionAvailabilitySupport.test.ts`
