> Migrated from `docs/review/step-07-provider-workspace-draft-callback-extraction-2026-04-09.md` on 2026-06-24.
...
- Extended `packages/sdkwork-agentstudio-pc-instances/src/components/instanceDetailSectionModels.ts`, which now owns:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1648`
...
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderPresentation.ts`: `33`
