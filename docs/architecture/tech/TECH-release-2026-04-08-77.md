...
# Agent Studio release-2026-04-08-77
...
- Reduced the recorded `packages/sdkwork-agentstudio-pc-instances/src/services/instanceWorkbenchServiceCore.ts` hotspot from the prior `1675`-line baseline to a fresh `1209` lines while keeping OpenClaw authority unchanged.
