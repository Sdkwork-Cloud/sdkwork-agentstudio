...
- Reduced the recorded `packages/sdkwork-clawstudio-instances/src/services/instanceWorkbenchServiceCore.ts` hotspot from the prior `1675`-line baseline to a fresh `1209` lines while keeping OpenClaw authority unchanged.
