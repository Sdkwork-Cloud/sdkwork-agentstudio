> Migrated from `docs/review/step-07-agent-dialog-draft-selection-extraction-2026-04-09.md` on 2026-06-24.
...
- Extended `packages/sdkwork-agentstudio-pc-instances/src/services/openClawAgentPresentation.ts` to own:
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1741`
