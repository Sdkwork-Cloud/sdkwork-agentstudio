> Migrated from `docs/review/step-07-managed-web-fetch-draft-state-extraction-2026-04-09.md` on 2026-06-24.
...
- `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx`: `1566`
- `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedConfigDrafts.ts`: `467`
