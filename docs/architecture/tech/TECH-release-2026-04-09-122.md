...
# Agent Studio release-2026-04-09-122
...
- Implemented the Step 07 extraction:
  ...
  - updated `packages/sdkwork-agentstudio-pc-instances/src/services/openClawProviderPresentation.test.ts`
  - rewired `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` so the page now consumes `createOpenClawProviderWorkspaceResetState(...)`
