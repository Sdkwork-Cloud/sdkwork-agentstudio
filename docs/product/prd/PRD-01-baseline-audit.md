...
2. 盘点热点文件：
   `packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` 约 `8081` 行、
   `packages/sdkwork-clawstudio-desktop/src-tauri/src/framework/services/studio.rs` 约 `8074` 行、
   `packages/sdkwork-clawstudio-instances/src/pages/InstanceDetail.tsx` 约 `5328` 行、
   `packages/sdkwork-clawstudio-chat/src/store/openClawGatewaySessionStore.ts` 约 `2767` 行、
   `packages/sdkwork-clawstudio-infrastructure/src/services/openClawGatewayClient.ts` 约 `2737` 行、
