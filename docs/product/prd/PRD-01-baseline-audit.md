...
2. 盘点热点文件：
   `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/local_ai_proxy.rs` 约 `8081` 行、
   `packages/sdkwork-agentstudio-pc-desktop/src-tauri/src/framework/services/studio.rs` 约 `8074` 行、
   `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` 约 `5328` 行、
   `packages/sdkwork-agentstudio-pc-chat/src/store/openClawGatewaySessionStore.ts` 约 `2767` 行、
   `packages/sdkwork-agentstudio-pc-infrastructure/src/services/openClawGatewayClient.ts` 约 `2737` 行、
