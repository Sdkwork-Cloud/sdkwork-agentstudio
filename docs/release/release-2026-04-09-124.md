# Agent Studio release-2026-04-09-124
...
- Implemented the Step 07 extraction:
  - added `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedChannelPresentation.ts`
  - added `packages/sdkwork-agentstudio-pc-instances/src/services/openClawManagedChannelPresentation.test.ts`
  - updated `packages/sdkwork-agentstudio-pc-instances/src/services/index.ts`
  - rewired `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` so the page now consumes `buildOpenClawManagedChannelWorkspaceSyncState(...)`
