# Agent Studio release-2026-04-09-121
...
- Implemented the Step 07 extraction:
  ...
  - rewired `packages/sdkwork-agentstudio-pc-instances/src/pages/InstanceDetail.tsx` so the page now consumes `createOpenClawAgentWorkspaceResetState(...)`
